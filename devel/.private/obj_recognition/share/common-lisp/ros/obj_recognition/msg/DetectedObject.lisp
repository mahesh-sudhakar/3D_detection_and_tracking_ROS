...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obj_recognition-msg:<DetectedObject> is deprecated: use obj_recognition-msg:DetectedObject instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obj_recognition-msg:label-val is deprecated.  Use obj_recognition-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obj_recognition-msg:cloud-val is deprecated.  Use obj_recognition-msg:cloud instead.")
  (cloud m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObject>)))
  ...
  "obj_recognition/DetectedObject")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObject)))
  "Returns string type for a message object of type 'DetectedObject"
  "obj_recognition/DetectedObject")
