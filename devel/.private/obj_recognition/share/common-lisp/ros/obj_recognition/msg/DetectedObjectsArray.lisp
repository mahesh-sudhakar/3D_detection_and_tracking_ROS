...
(cl:defclass <DetectedObjectsArray> (roslisp-msg-protocol:ros-message)
  ((objects
    :reader objects
    :initarg :objects
    :type (cl:vector obj_recognition-msg:DetectedObject)
   :initform (cl:make-array 0 :element-type 'obj_recognition-msg:DetectedObject :initial-element (cl:make-instance 'obj_recognition-msg:DetectedObject))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObjectsArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObjectsArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obj_recognition-msg:<DetectedObjectsArray> is deprecated: use obj_recognition-msg:DetectedObjectsArray instead.")))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <DetectedObjectsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obj_recognition-msg:objects-val is deprecated.  Use obj_recognition-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObjectsArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'obj_recognition-msg:DetectedObject))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObjectsArray>)))
  ...
  "obj_recognition/DetectedObjectsArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObjectsArray)))
  "Returns string type for a message object of type 'DetectedObjectsArray"
  "obj_recognition/DetectedObjectsArray")
