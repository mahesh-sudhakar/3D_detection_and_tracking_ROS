...
if(NOT "/home/ruthz/detection_ws/devel/.private/obj_recognition/include " STREQUAL " ")
  set(obj_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/ruthz/detection_ws/devel/.private/obj_recognition/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'obj_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruthz/detection_ws/src/PCL-ROS-cluster-Segmentation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ruthz/detection_ws/devel/.private/obj_recognition/lib;/home/ruthz/detection_ws/devel/lib;/opt/ros/kinetic/lib)
